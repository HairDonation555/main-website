    ...
    <div id="contactus" className="bg-primary py-12 items-center justify-center md:px-12 lg:px-24">
      <div className="w-full items-center justify-center">
        ...
        <div className="mt-10 flex flex-col items-center p-2 justify-center gap-8">
          {formType === "consent" ? (
            <motion.div {...motionProps} className="bg-white w-full max-w-6xl rounded-lg mb-8 p-8">
            ...
            <motion.div {...motionProps} className="bg-white md:w-[500px] w-[300px] rounded-lg p-6">
