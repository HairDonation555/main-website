...
function About() {
  return (
    <div id='about' className='flex flex-col md:flex-row md:gap-12 gap-6 items-center w-full h-full justify-center py-14 px-6 md:px-14'>
      <img 
        src='/images/about.png' 
        className='w-full md:w-[700px] h-auto md:h-[650px] object-cover' 
        alt='About Us'
      />
      <div className='flex flex-col gap-4 px-6 md:px-12 py-12 m-4 text-center '>
