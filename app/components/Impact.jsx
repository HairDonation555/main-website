...
function Impact() {
  ...
  {/* Card Container */}
  <div className="relative flex flex-col items-center text-center bg-white/80 backdrop-blur-lg border border-yellow-200 rounded-md shadow-xl p-8 w-72 md:w-80  transition-all duration-500 ease-in-out">
    
    {/* Play Button Image */}
    <div className="relative w-36 h-36 mb-6 overflow-hidden rounded-md shadow-lg">
      <Image
        src="/images/1m.jpeg"
    ...
    {/* Badge */}
    <div className="px-4 py-1 rounded-full bg-yellow-50 border border-yellow-300 text-yellow-800 font-semibold text-sm tracking-wide shadow-sm">
      Gold Milestone
    </div>
  </div>
</div>
  ...
  <div className="relative flex flex-col items-center text-center bg-white/80 backdrop-blur-lg border border-yellow-200 rounded-md shadow-xl p-8 w-72 md:w-80   transition-all duration-500 ease-in-out">
    ...
    {/* Badge */}
    <div className="px-4 py-1 rounded-full bg-gray-200 border border-gray/30 text-gray-800 font-semibold text-sm tracking-wide shadow-sm">
      Silver Milestone
    </div>
  </div>
</div>
